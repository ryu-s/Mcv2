...
class ProgressChangedEventArgs : EventArgs
{
    ...
    public ProgressChangedEventArgs(long? totalFileSize, long totalBytesDownloaded, double? progressPercentage)
    {
...
class HttpClientDownloadWithProgress : IDisposable
{
    ...
    private void TriggerProgressChanged(long? totalDownloadSize, long totalBytesRead)
    {
        ...
        ProgressChanged?.Invoke(this, new ProgressChangedEventArgs(totalDownloadSize, totalBytesRead, progressPercentage));
    }
