...
namespace TwicasSitePluginTests
{
    ...
    class ToolsTests
    {
        ...
        public void IsKiitosTest()
        {
            ...
            var item = c.Items[1];
            Assert.That(Tools.IsKiitos(item), Is.True);
        }
        [Test]
        public void Test()
        {
            Assert.That(Tools.DecodeBase64("Zmxvd2l0ZW0oImh0dHBzOi8vdHdpdGNhc3RpbmcudHYvaW1nL2FuaW0vYW5pbV90ZWFfMTAiLCAzMDAwLCAxLCAxLCA1KQ=="), Is.EqualTo("flowitem(\"https://twitcasting.tv/img/anim/anim_tea_10\", 3000, 1, 1, 5)"));
        }
        [Test]
