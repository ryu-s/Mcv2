...
namespace TwitchSitePluginTests
{
    ...
    public class ToolsGetMessageItemsTests
    {
        ...
        public void Twitch_PrivmsgParseTest2()
        {
            ...
            var actual = TwitchSitePlugin.Tools.GetMessageItems(TwitchSitePlugin.Tools.Parse(message));//TODO:Parse()を介さず直接Resultを渡したい

            var expected = new List<IMessagePart>
            {
                MessagePartFactory.CreateMessageText("@bwscar221 おざまぁぁぁす！ "),
                new MessageImage{Url="https://static-cdn.jtvnw.net/emoticons/v1/189031/1.0", Alt="mimicchiHage"},
                MessagePartFactory.CreateMessageText(" "),
        ...
        public void Twitch_PrivmsgParseTest1()
        {
            ...
            var actual = TwitchSitePlugin.Tools.GetMessageItems(TwitchSitePlugin.Tools.Parse(s));
            var expected = new List<IMessagePart>
            {
                MessagePartFactory.CreateMessageText("いぐすりいいぞ！！ "),
        ...
        public void Twitch_PrivmsgParseTest0()
        {
            ...
            var expected = new List<IMessagePart>
            {
                MessagePartFactory.CreateMessageText("出るんだとしたら２０周年が丁度いいんじゃないかなって"),
            };
            CollectionAssert.AreEquivalent(expected, actual);
        }
    }
