...
public class ProtobufParserTests
{
    ...
    public void ParseBackward()
    {
        ...
        var a = PackedSegment.Create(data);
        Assert.That(a.Messages.Count, Is.EqualTo(425));
    }
    [Test]
    ...
    [Test]
    public void CreateNicoliveStateStatisticsTest()
    {
        var data = new byte[] { 0x0A, 0x08, 0x08, 0xBD, 0x03, 0x10, 0xBB, 0x03, 0x20, 0x46 };
        var a = NicoliveState.Create(data);
    ...
    public void ParseModifierTest()
    {
        ...
        var a = ChatModifier.Create(data);
    ...
    public void ParseGiftTest()
    {
        ...
        var gift = a.Gift!;
        Assert.That(gift.Content, Is.EqualTo($"あずMOMOさんがギフト「ニコる（20pt）」を贈りました"));
    }
    [Test]
    public void Parr()
    {
    ...
    {
        var data = new byte[] { 0x22, 0x17, 0x0A, 0x15, 0x0A, 0x0F, 0x0A, 0x09, 0x65, 0x77, 0x62, 0x63, 0x77, 0x6A, 0x5F, 0x6C, 0x76, 0x1A, 0x02, 0x18, 0x00, 0x1A, 0x02, 0x08, 0x0F };
        var a = NicoliveState.Create(data);
        Assert.Multiple(() =>
        {
            Assert.That(a.Marquee!.Display!.OperatorComment.Content, Is.EqualTo("ewbcwj_lv"));
            Assert.That(a.Marquee!.Display!.Duration, Is.EqualTo(15));
        });
    }
    [Test]
    public void ParseNicoLiveStateMoveOrderTest()
    {
        var data = new byte[] { 0x1A, 0x33, 0x0A, 0x31, 0x0A, 0x0B, 0x6C, 0x76, 0x33, 0x34, 0x35, 0x39, 0x34, 0x32, 0x35, 0x30, 0x36, 0x12, 0x1E, 0xE3, 0x83, 0x8B, 0xE3, 0x82, 0xB3, 0xE3, 0x83, 0x8B, 0xE3, 0x82, 0xB3, 0xE3, 0x83, 0x8B, 0xE3, 0x83, 0xA5, 0xE3, 0x83, 0xBC, 0xE3, 0x82, 0xB9, 0xE5, 0xAE, 0x9F, 0xE6, 0xB3, 0x81, 0x22, 0x02, 0x08, 0x14 };
        var a = NicoliveState.Create(data);

    }
    [Test]
    public void ParseNicoAdTest()
    {
        var data = new byte[] {  };
        var a = Nicoad.Create(data);

    }
    [Test]
    public void ParseNicoLiveStateEnqueteTest()
    {
        var data = new byte[] {  };
        var a = NicoliveState.Create(data);
    ...
    {
        var data = new byte[] { 0x0A, 0x15, 0xE3, 0x81, 0xA8, 0xE3, 0x81, 0xA6, 0xE3, 0x82, 0x82, 0xE8, 0x89, 0xAF, 0xE3, 0x81, 0x8B, 0xE3, 0x81, 0xA3, 0xE3, 0x81, 0x9F, 0x18, 0x97, 0x06 };
        var a = Choice.Create(data);
    }
    [Test]
    public void ParseChunkMessageTest111()
    {
        var data = new byte[] { 0x0A, 0x3E, 0x0A, 0x24, 0x45, 0x68, 0x6B, 0x4B, 0x45, 0x67, 0x6D, 0x54, 0x65, 0x65, 0x39, 0x67, 0x6C, 0x57, 0x65, 0x53, 0x41, 0x52, 0x46, 0x5A, 0x56, 0x46, 0x73, 0x7A, 0x4D, 0x31, 0x64, 0x4E, 0x74, 0x42, 0x44, 0x62, 0x34, 0x73, 0x77, 0x73, 0x12, 0x0C, 0x08, 0xC7, 0xFA, 0x8F, 0xB8, 0x06, 0x10, 0xC0, 0x86, 0xA6, 0xB6, 0x03, 0x1A, 0x08, 0x0A, 0x06, 0x08, 0x9B, 0x8E, 0xFA, 0xA4, 0x01, 0x22, 0x02, 0x12, 0x00 };
        var a = ChunkedMessage.Create(data);
    }
}
